...
public class MorseCodeConverterTest {
	...
	public void testConvertToEnglishString() {	
		...
		//STUDENT TEST!!!
		String nameMorse="-- -.-- / -. .- -- . / .. ... / --- -.. .- .-.. .. ... / ..-. .-.. --- .-. . ... ";
		String name="my name is odalis flores";
		String nameConversion = MorseCodeConverter.convertToEnglish(nameMorse);
		assertEquals(name,nameConversion);
	}
	...
	public void testConvertToEnglishFile() throws FileNotFoundException {
		...
		//STUDENT TEST
		String studentTest="testing testing";		
